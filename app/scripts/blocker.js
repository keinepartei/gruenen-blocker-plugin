...
const overlayTplTop = `
    <div class="gb-cb-ol">
        ...
        <div class="gb-cb-ol-bottom"><b class="gb-cb-ol-title">Gr&uuml;nen Blocker</b>
...
const overlayTpl = `
    <div class="gb-cb-ol">
        <div class="gb-cb-ol-top"><b class="gb-cb-ol-title">Gr&uuml;nen Blocker</b></div>
        <div class="gb-cb-ol-bottom"><p class="gb-cb-ol-txt">
            100% B&uuml;ndnis 90/Die Gr&uuml;nen inhaltsfrei.<br>
            Für Sie blockiert von keiner Partei!<br></p>
            <img class="gb-cb-ol-bg" src="data:image/png;base64," alt="KEINE PARTEI">
        </div>
        ...
        if (!node.element.classList.contains('gb-cb')) {
            ...
            if (node.type === 'big') {
            	if (node.align === 'top') {
            		...
            		if (node.imageHeight) {
            			overlay.getElementsByClassName('gb-cb-ol-top')[0].style.setProperty('height', node.imageHeight);
            			overlay.getElementsByClassName('gb-cb-ol-bottom')[0].style.setProperty('top', node.imageHeight);
            		}
            	} else if (node.align === 'left') {
            		overlay = overlayNodeTop.cloneNode(true);
            		overlay.className += " gb-cb-ol-left";
            		if (node.imageWidth) {
            			overlay.getElementsByClassName('gb-cb-ol-top')[0].style.setProperty('width', node.imageWidth);
            			overlay.getElementsByClassName('gb-cb-ol-bottom')[0].style.setProperty('left', node.imageWidth);
            		}
            	} else {
            		overlay = overlayNode.cloneNode(true);
            	}
            	if (node.txt) {
            		overlay.getElementsByClassName('gb-cb-ol-txt')[0].style = node.txt;
            	}
            } else {
