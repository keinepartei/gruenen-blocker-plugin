...
function parseHtml(html, base64Content) {
    ...
    if (base64Content) {
    	var background = parsed.getElementsByClassName('overlaybackground')[0];  
 ...
 * @type {Element}
 */
var overlayNode = parseHtml(overlayHTML);
 ...
 * @type {Element}
 */
const overlaySmallNode = parseHtmlSmall(overlayHTMLSmall);
...
export class Blocker {
	...
	updateOverlayBackground(base64Content) {
		console.log('SET OVERLAY');
		overlayNode = parseHtml(overlayHTML,base64Content);
	}
